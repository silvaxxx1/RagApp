...
Revision ID: 631fb1f26f3f
Revises: 
Create Date: 2025-08-29 15:33:23.610338
...
def upgrade() -> None:
    ...
    sa.Column('chuck_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('chuck_order', sa.Integer(), nullable=False),
